...
:pharstable:  http://bartlett.laurent-laville.org/get/phpcompatinfo-5.1.0.phar
...
[source,bash]
----
$ chmod +x phpcompatinfo-5.1.0.phar
$ mv phpcompatinfo-5.1.0.phar /usr/local/bin/phpcompatinfo
...
[source,bash]
----
$ wget http://bartlett.laurent-laville.org/get/phpcompatinfo-5.1.0.phar
$ php phpcompatinfo-5.1.0.phar --version
----
...
====
----
phpCompatInfo version 5.1.0 DB version 1.19.0 built Mar 16 2017 21:17:30 CET
----
====
